        # Nmatransport: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/nmatransport.git

        ## Objective

        NMATransport extends network meta-analysis with transportability adjustments, allowing pooled estimates to be tailored to target populations differing from trial samples.
        ...
        - Code: https://github.com/mahmood726-cyber/nmatransport.git
        - Dashboard: N/A
